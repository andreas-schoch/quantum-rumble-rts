...
export default class GameScene extends Phaser.Scene {
  ...
  private create() {
    ...
    emitterManager.addEmitter({xCoord: 2, yCoord: 2, fluidPerSecond: 3276800000, ticksCooldown: 1, ticksDelay: 0});
    ...
    emitterManager.addEmitter({xCoord: WORLD_X - 2, yCoord: WORLD_Y - 2, fluidPerSecond: 32768 / 4, ticksCooldown: 1, ticksDelay: 0});
